...
| ExpansionPak, GXRuntime/DolRecomp-compatible runtime | PowerPC context, hardware/runtime support and recompilation ABI | GPL-3.0-or-later; retained notices in `native/vendor` |
...
| [Unicorn Engine](https://github.com/unicorn-engine/unicorn), Nguyen Anh Quynh and contributors | Execution of added/patched PowerPC instructions alongside native recompiled game code | GPL-2.0 with component notices; the Windows content runtime bundles Unicorn 2.1.4, with exact notices in `native/vendor/unicorn` |
