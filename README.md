...
- Options includes **Controller** (mapping, input visualization, tap jump and per-port trigger settings: where the L/R click engages, light shield and trigger dead zone) and **Widescreen**, with 4:3 and 16:9 choices. Character select uses static portraits; the experimental live 3D previews have been removed.
